...
<div class="box box-info" style="width:900px;height:50px;background-color:yellow;">
            <div class="box-header with-border">
              <h3 class="box-title">Modifica Pais Id : {{$idpais->id}}</h3>
            </div>
                    @if(count($errors) > 0)
                        <div class="errors">
                            <ul>
            ...
            <form class="form-horizontal"  method="POST" action="{{url('/paises/'.$idpais->id)}}">
              ...
              <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {{Form::text('nombre', $idpais->nombre,['class' => 'form-control'])}}
                    </div>
                  </div>
                  ...
                  <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-info pull-right">Actualiar Pais</button>
                  </div>
