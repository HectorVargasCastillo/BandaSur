...
<head>
  ...
  <!-- Ionicons -->
  <link rel="stylesheet" href="{{ asset('js/Ionicons/css/ionicons.min.css')}}js/Ionicons/css/ionicons.min.css">
  <!-- fullCalendar -->
  <link rel="stylesheet" href="{{asset('js/fullcalendar/dist/fullcalendar.min.css')}}">
  <link rel="stylesheet" href="{{asset('js/fullcalendar/dist/fullcalendar.print.min.css')}}" media="print">
  <!-- Theme style -->
...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Administrador 1</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <!--<a href="../widgets.html">-->
            ...
            <i class="fa fa-th"></i> <span>Estilos</span>
            <span class="pull-right-container">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active">
              <a href="mailbox.html">Bandeja Entrada
                <span class="pull-right-container">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="compose.html" class="btn btn-primary btn-block margin-bottom">Componer</a>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="#"><i class="fa fa-inbox"></i> Bandeja Entrada
                  <span class="label label-primary pull-right">12</span></a></li>
                <li><a href="#"><i class="fa fa-envelope-o"></i> Enviados</a></li>
                <li><a href="#"><i class="fa fa-file-text-o"></i> Borradores</a></li>
                <li><a href="#"><i class="fa fa-filter"></i> No Deseados <span class="label label-warning pull-right">65</span></a>
                </li>
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Bandeja Entrada</h3>
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name"><a href="read-mail.html">Esteban Quito</a></td>
                    <td class="mailbox-subject"><b>Informa Problema Ac</b> - Tratando de encontrar una solución a este problema ...
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="mailbox-date">hace 28 minutos</td>
                  </tr>
                  <tr>
                    <td><input type="checkbox"></td>
                    <td class="mailbox-star"><a href="#"><i class="fa fa-star-o text-yellow"></i></a></td>
                  ...
                  <tr>
                    ...
                    <td class="mailbox-attachment"><i class="fa fa-paperclip"></i></td>
                    <td class="mailbox-date">hace 4 dias</td>
                  </tr>
                  <tr>
                    <td><input type="checkbox"></td>
                    <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                    ...
                    <td class="mailbox-attachment"></td>
                    <td class="mailbox-date">hace 12 dias</td>
                  </tr>
                  <tr>
                    <td><input type="checkbox"></td>
                    <td class="mailbox-star"><a href="#"><i class="fa fa-star-o text-yellow"></i></a></td>
                  ...
                  <tr>
                    ...
                    <td class="mailbox-attachment"><i class="fa fa-paperclip"></i></td>
                    <td class="mailbox-date">hace 14 dias</td>
                  </tr>
                  <tr>
                    <td><input type="checkbox"></td>
                    <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                    ...
                    <td class="mailbox-attachment"><i class="fa fa-paperclip"></i></td>
                    <td class="mailbox-date">hace 15 dias</td>
                  </tr>
                  </tbody>
                </table>
                <!-- /.table -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018-2020 <a href="https://adminlte.io">BandaSur.cl</a>.</strong> Todos los derechos reservado.
  </footer>
