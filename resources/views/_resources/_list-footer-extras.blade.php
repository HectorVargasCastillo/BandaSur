    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-red color-palette">
                ...
                <h4 class="modal-title" id="modalConfirmModelDeleteLabel">Esta Seguro<i class="fa fa-question"></i>
                </h4>
            </div>
            <div class="modal-body">
                <p> Esta Seguro de Eliminar este Registro<i class="fa fa-question"></i></p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" id="btnModalConfirmModelDelete" data-form-id="">Confirmar
                </button>
